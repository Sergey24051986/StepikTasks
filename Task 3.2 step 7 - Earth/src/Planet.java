...
public class Planet extends JComponent {
    ...
    public Planet(int planetX, int planetY, int planetR, String fileName) throws Exception {
        ...
        img = ImageIO.read(new File("Task 3.2 step 7 - Earth/Image/" + fileName + ".png"));
    ...
    public static void paintEarth () throws IOException {
        ...
        BufferedImage earthImgOrig = ImageIO.read(new File ("Task 3.2 step 7 - Earth/Image/EarthOrig.jpg")).getSubimage(90,90,1050,1000); // Берем только часть изображения
        ...
        ImageIO.write(earthImgFinal,"png",new File("Task 3.2 step 7 - Earth/Image/Earth.png"));// Записываем в файл, для дальнейшего использования
    }
}
