...
public class Picture extends JComponent {
    ...
    private int pX = 0;
    private  int pY = 0;
    private static Color color = new Color(new Random().nextInt(256), new Random().nextInt(256), new Random().nextInt(256));
    ...
    protected void paintComponent(Graphics g) {
        try {
            paintDVD();
            img = ImageIO.read(new File("Task 3.02/step 6 - DVD/Image/DVD.png"));
        } catch (IOException e) {
    ...
    public void paintDVD() throws IOException {
        ...
        ImageIO.write(dvdCopy, "png", new File("Task 3.02/step 6 - DVD/Image/DVD.png"));
