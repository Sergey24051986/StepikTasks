...
public class ImageEditor extends JFrame {
    ...
    public ImageEditor () throws IOException {
        ...
        buttonLoading.addActionListener(e -> {
            JFileChooser chooser = new JFileChooser("Task 3.02/step 8 - OtherPlanets/ImageEditor/Image/Original/");
    ...
    public void saveImg() throws IOException {
        ...
        JFileChooser chooser = new JFileChooser("Task 3.02/step 8 - OtherPlanets/ImageEditor/Image/Processed/");
