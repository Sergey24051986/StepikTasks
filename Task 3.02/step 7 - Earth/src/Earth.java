...
public class Earth extends JFrame implements Runnable{
    ...
    static class Background extends JComponent {
        ...
        public Background() throws IOException {
            background = ImageIO.read(new File("Task 3.02/step 7 - Earth/Image/Space.png"));
        }
    ...
    public static void paintSpace () throws IOException {
        ...
        BufferedImage sunImgOrig = ImageIO.read(new File ("Task 3.02/step 7 - Earth/Image/SunOrig.jpg")).getSubimage(400,0,1800,1600); // Берем только часть изображения
        ...
        BufferedImage spaceImgOrig = ImageIO.read(new File ("Task 3.02/step 7 - Earth/Image/SpaceOrig.jpg"));
        ...
        ImageIO.write(spaceImg,"png",new File("Task 3.02/step 7 - Earth/Image/Space.png"));// Записываем готовое изображение, для дальнейшей работы
    }
