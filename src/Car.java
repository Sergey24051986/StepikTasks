...
public class Car extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        g2D.drawImage(img, 0, 0, width, height, null); // рисует в окне с текущими размерами
    }
    ...
    public static void main(String[] args) {
        ...
        //ImageIO.write(img,"png",new File("Car.png"));
    }

    public void paintCar() { // Рисует в img рисунок
