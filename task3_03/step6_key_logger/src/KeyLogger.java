...
public class KeyLogger extends JFrame {
    ...
    public KeyLogger() throws IOException {
        ...
        writer = new PrintWriter("task3_03/step6_key_logger/Text.txt");
        ...
        g2D.drawImage(ImageIO.read(new File("task3_03/step6_key_logger/Image/Background.jpg")), 0, 0, width, height, null);
