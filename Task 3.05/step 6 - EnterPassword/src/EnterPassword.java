...
public class EnterPassword {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            else JOptionPane.showMessageDialog(null, "Логин должен быть больше 5 символов и не должен содержать пробелов!", "Подсказка!", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        while (true) {
            ...
            else JOptionPane.showMessageDialog(null, "Пароли не совпадают, попробуйте ещё раз!", "Подсказка!", JOptionPane.INFORMATION_MESSAGE);
        }
